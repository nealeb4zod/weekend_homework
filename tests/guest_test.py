...
class TestGuest(unittest.TestCase):
    def setUp(self):
        ...
        self.guest_1 = Guest("John McLean", 39, song_1, 100.00)
        self.guest_2 = Guest("Al Powell", 43, song_2, 50.00)
        self.guest_3 = Guest("Hans Gruber", 47, song_3, 10000.00)
        self.guest_4 = Guest("Karl Vreski", 35, song_4, 0.00)
